 ...
 */
namespace SomethingDigital\AjaxLayeredNav\Model\ResourceModel\CatalogSearch\Fulltext;
...
class Collection extends \Magento\Catalog\Model\ResourceModel\Product\Collection
{
    ...
    public function addFieldToFilter($field, $condition = null)
    {
        ...
        if ($field != 'visibility' && (!is_array($condition) || !in_array(key($condition), ['from', 'to'], true))) {
